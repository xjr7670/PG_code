...
#  统计结果包含pastdue和exception errors
...
class Get_past_due_total(object):
    ...
    def __init__(self, file):
        ...
        pase_due_end = self.html.find('Exception&nbsp;Errors')
        self.html = self.html[:pase_due_end]
...
if __name__ == "__main__":
    ...
    # MRP_C list
    mrp_c_list = ["F01", "F02", "F03", "F04", "F05", "F06", "F08", "F09"]

    # MRP_element list
    mrp_element_list = ['AR Order.res.',
          'BA PurRequist',
          'BE Purch.ord.',
          'BR Proc.order',
          'LA Ship.note',
